        ...
        <div className="container mx-auto ">
          <div className="flex flex-col lg:flex-row lg:justify-between">
            ...
            <div className="w-full md:w-1/2  px-4 mb-8 md:mb-0">
              ...
              <p className="text-sm">Email: <span className="text-purple-200 hover:underline cursor-pointer">info.luminary@google.com</span></p>
              <p className="text-sm">Phone: <span className="text-purple-200 hover:underline cursor-pointer">973-426-7690</span></p>
            </div>
            <div className="w-full   px-4 mb-8 md:mb-0">
