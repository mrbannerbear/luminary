...
const Banner = () => {
  ...
  let bannerArray: bannerType[] = [
    {
      url: "https://images.unsplash.com/photo-1622450185809-9ca98502e030?q=80&w=1932&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
  ...
  const [bannerContent, setBannerContent] = useState<bannerType>(
    bannerArray[0]
  );
